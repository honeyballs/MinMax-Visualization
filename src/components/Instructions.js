...
const Instructions = props => {
    return (
        <div className="instructions">
            <p>You can change the depth of the tree and how many options each recursion will calculate on the left side of the screen.</p>
            ...
            <p>After the algorithm finished you can use the slider at the bottom of the screen to view its calculations step by step. <br/>The slider will track multiple runs of the algorithm. Please reset before changing the settings and running the algorithm again.</p>
